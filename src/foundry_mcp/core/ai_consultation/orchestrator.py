...
Central orchestrator for AI consultation workflows. Coordinates between
prompt templates, the provider registry, and the result cache to execute
consultation requests. Handles provider selection, timeout management,
retry/fallback logic, and error handling.
"""
