...
| `deep_research_reflection_timeout` | float | `120.0` | Reflection/think timeout (seconds) |
| `deep_research_topic_research_timeout` | float | `180.0` | Topic research LLM call timeout (seconds) |
